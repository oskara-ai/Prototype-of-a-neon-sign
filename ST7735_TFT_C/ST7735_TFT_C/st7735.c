...
//omat alkaa
void st7735_set_bl(){
	 PORTA |= (1<<PA0); // set backlight on 
}

void st7735_unset_bl(){
	PORTA &= ~(1<<PA0); // set baglight off
}

void st7735_dspl_off(){ // function to set display off
	st7735_unset_rs();
	spi_unset_cs_tft();
...
void st7735_dspl_on(){ // function to set display on 
	st7735_unset_rs();
	spi_unset_cs_tft();
